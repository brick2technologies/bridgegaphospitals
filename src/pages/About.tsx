...
export default function AboutPage() {
  // Removed unused activeDoctor state
  ...
  return (
    <div className="relative bg-gradient-to-br from-gray-50 via-white to-purple-50 overflow-hidden">
      {/* Hero Section */}
      <section className="relative py-20 lg:py-28 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-6 lg:px-8">
          ...
          >
            <div className="relative h-96 bg-gradient-to-br from-purple-200 via-pink-200 to-blue-200">
              <img 
                src="https://images.unsplash.com/photo-1519494026892-80bbd2d6fd0d?w=1200&h=600&fit=crop" 
                alt="Bridge Gap Hospital" 
            ...
            >
              ...
              <div className="mt-8 flex flex-wrap gap-4">
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="px-8 py-4 bg-gradient-to-r from-[#E92393] to-purple-600 text-white font-bold rounded-full shadow-lg hover:shadow-xl transition-all duration-300 flex items-center gap-3"
                >
