...
export default function GalleryPage() {
  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-br from-gray-50 via-white to-blue-50 overflow-hidden mt-6">
      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-8 py-20">
        ...
        >
          ...
          >
            Explore our journey of healing, community service, and
            state-of-the-art facilities dedicated to fighting cancer together.
          </motion.p>
        </motion.div>
              ...
              >
                ...
                >
                  ...
                  <div className="relative h-full overflow-hidden">
                    ...
                    {/* Gradient overlay */}
                    <div
                      className={`absolute inset-0 bg-gradient-to-t ${item.gradient} opacity-0 group-hover:opacity-60 transition-opacity duration-500`}
                    />
                    {/* Zoom icon */}
                    <div
                    ...
                    >
                      <ZoomIn className="w-5 h-5 text-[#E92393]" />
                    </div>
                  </div>
