...
function CancerCareSection() {
  ...
  const services = [
    {
      ...
      description:
        "Highly experienced cancer specialists dedicated to creating personalized treatment plans for your unique journey.",
    ...
    },
    {
      ...
      description:
        "State-of-the-art imaging and laboratory technology ensuring accurate diagnosis and precise treatment monitoring.",
    ...
    },
    {
      ...
      description:
        "Compassionate counseling and psychological care to support you and your loved ones through every step.",
    ...
    },
    {
      ...
      description:
        "Connect with fellow warriors, share experiences, and find strength in our caring community of survivors and caregivers.",
    ...
    },
    {
      ...
      description:
        "Flexible payment plans and financial counseling to ensure quality care remains accessible to everyone.",
  ...
  // ✅ Variants extracted outside render to avoid re-creation
  ...
  return (
    <section
      id="cancer-care"
      aria-labelledby="cancer-care-heading"
      className="relative py-20 lg:py-28 bg-linear-to-br from-white via-purple-50 to-pink-50 overflow-hidden"
    >
      {/* Decorative gradients - aria-hidden for accessibility */}
      <div
        aria-hidden="true"
      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-8">
        ...
        >
          ...
          >
            From diagnosis to recovery and beyond, we provide holistic care that
            addresses every aspect of your cancer journey with compassion and
            expertise.
          </motion.p>
        </motion.div>
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  <div
                    aria-hidden="true"
                    className={`absolute -top-10 -right-10 w-32 h-32 bg-linear-to-br ${service.gradient} opacity-0 group-hover:opacity-20 rounded-full transition-opacity duration-500`}
                  />
                </div>
              </motion.article>
            );
        ...
        >
          <div className="relative inline-block">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="relative px-10 py-5 bg-linear-to-r from-[#E92393] via-purple-600 to-[#E92393] text-white text-lg font-bold rounded-full shadow-2xl hover:shadow-3xl transition-all duration-300 flex items-center gap-3 focus:outline-none focus-visible:ring-4 focus-visible:ring-pink-300"
              aria-label="Schedule your cancer consultation at Bridge Gap Hospitals"
            >
...
export default memo(CancerCareSection);
