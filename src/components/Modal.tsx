      ...
      {isOpen && (
        ...
        >
          ...
          >
            <button
              onClick={onClose}
              className="absolute top-3 right-3 z-10 w-10 h-10 bg-pink-100 rounded-full flex items-center justify-center shadow-md hover:bg-pink-200 transition-all"
            >
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2 rounded-xl border-2 border-pink-200 focus:border-pink-400 focus:outline-none bg-white text-gray-800 placeholder:text-gray-400 text-sm"
                      placeholder="Emma"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      className="w-full px-3 py-2 rounded-xl border-2 border-blue-200 focus:border-blue-400 focus:outline-none bg-white text-gray-800 placeholder:text-gray-400 text-sm"
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      className="w-full px-3 py-2 rounded-xl border-2 border-purple-200 focus:border-purple-400 focus:outline-none bg-white text-gray-800 placeholder:text-gray-400 text-sm"
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div>
                      ...
                      <input
                        ...
                        value={formData.date}
                        onChange={handleChange}
                        className="w-full px-3 py-2 rounded-xl border-2 border-green-200 focus:border-green-400 focus:outline-none bg-white text-gray-800 text-sm"
                      />
                    </div>
                    <div>
                      ...
                      <input
                        ...
                        value={formData.time}
                        onChange={handleChange}
                        className="w-full px-3 py-2 rounded-xl border-2 border-orange-200 focus:border-orange-400 focus:outline-none bg-white text-gray-800 text-sm"
                      />
                    </div>
                  </div>
                  ...
                  <div className="flex justify-end gap-3 pt-3">
                    ...
                    >
                      <motion.span
                        animate={showHearts ? { scale: [1, 1.2, 1] } : {}}
                      >
                        Book Now
                      </motion.span>
