...
import Modal from "./Modal"; // Now used
          ...
          <div className="flex justify-between items-center h-20 lg:h-24">
            ...
            >
              <motion.button
                ...
                className="group relative px-5 py-2.5 rounded-full bg-gradient-to-r from-[#E92393] to-[#F472B6] text-white font-semibold shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden"
              >
              ...
              <motion.button
                ...
                className="group relative px-5 py-2.5 rounded-full border-2 border-[#005AA9] text-[#005AA9] font-semibold hover:bg-[#005AA9] hover:text-white transition-all duration-300"
              >
